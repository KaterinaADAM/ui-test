...
public class Social_EmailNotifications_NotificationType extends Notification {
	...
	public  void test01_ConnectRequestNotificationMail() {
		...
		//Update email
		magAcc.updateUserProfile(null, "John", "Smith", EMAIL_ADDRESS1);
		...
		waitForAndGetElement(eEmail,100000);
		click(eEmail);
...
//		clickByJavascriptWithClassName("ar9 T-I-J3 J-J5-Ji",1);
		click(ELEMENT_GMAIL_INBOX);
		click(eEmail2);
		Set<String> existingHandles1 = driver.getWindowHandles();
		click(By.linkText("Refuse"));
		String handle1 = FindNewWindowHandle(existingHandles1, 12000);
		...
		driver.switchTo().window(handleGmail);
		getElementByJavascript("ar9 T-I-J3 J-J5-Ji",1).click();
	...
	public  void test03_CommentNotificationMail() {
		...
		Set<String> existingHandles = driver.getWindowHandles();
		click(By.linkText("Reply"));
		String handle2 = FindNewWindowHandle(existingHandles, 12000);
	...
	public  void test05_PostOnMySpacesNotificationMail() {
		...
		waitForAndGetElement(sp.ELEMENT_SPACE_CONFIGURATION);
	...
	public  void test06_SpaceJoinRequestNotificationMail() {
		...
		clickByJavascriptWithClassName("ar9 T-I-J3 J-J5-Ji",1);
		click(eEmail3);
		Set<String> existingHandles2 = driver.getWindowHandles();
		click(By.linkText("Validate"));
		String handle2 = FindNewWindowHandle(existingHandles2, 12000);
		driver.switchTo().window(handle2);
		driver.manage().window().maximize();
	...
	* Test Case Name: Format of notification email.
	...
	public  void test07_SpaceInvitationNotificationMailAndCheckFormat() {
		...
		goToMail(EMAIL_ADDRESS1, EMAIL_PASS);
		String handleGmail = driver.getWindowHandle();
		waitForAndGetElement(eEmail,200000);
		click(eEmail);
		...
		driver.switchTo().window(handleGmail);
		Set<String> existingHandles3 = driver.getWindowHandles();
		info("Check link 'click here' (caseID 109849)");
		click(By.linkText("click here"));
		String handle3 = FindNewWindowHandle(existingHandles3, 12000);
	...
	/*	magAcc.updateUserProfile(null, "John", "Smith", EMAIL_ADDRESS1);
		...
		magAcc.userSignIn(userType.PUBLISHER);
		/*act.addActivity(true, activity, false, "");
		act.mentionActivity(false, activity, "John");*/
...
//		magAcc.userSignIn(userType.ADMIN);
		...
		driver.switchTo().window(handleGmail);
//		waitForAndGetElement(ELEMENT_DELETE_MAIL_2).click(); 
//		clickByJavascriptWithClassName("ar9 T-I-J3 J-J5-Ji");
		click(ELEMENT_GMAIL_INBOX);
		click(eEmail2);
		Set<String> existingHandles2 = driver.getWindowHandles();
		click(By.linkText("Reply"));
	...
	*/
	...
	public  void test09_NewUserNotificationMail() {
		...
		*Expected Outcome: 
		...
		String handle1 = FindNewWindowHandle(existingHandles, 12000);
		driver.switchTo().window(handle1);
		...
		String handle2 = FindNewWindowHandle(existingHandles1, 12000);
		driver.switchTo().window(handle2);
		driver.manage().window().maximize();
		...
		*Expected Outcome: Send a connection request to the user that has just joined the social intranet. It will also take the user to the portal and open this new connection's profile.		*/ 
		...
		String handle3 = FindNewWindowHandle(existingHandles2, 12000);
		driver.switchTo().window(handle3);
		driver.manage().window().maximize();
		waitForAndGetElement(ELEMENT_PROFILE_PAGE.replace("${user}", fullName));
