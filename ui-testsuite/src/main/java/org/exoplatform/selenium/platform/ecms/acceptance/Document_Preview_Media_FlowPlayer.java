...
public class Document_Preview_Media_FlowPlayer extends Document_Preview_TestConfig {
	
	/**
	 * MEDIA_02:
	 * The accessible player FlowPlayer is used to view the following file suffixes:
	 * - flv
	 * - f4v
	 */
	@Test
	public void test01_CheckPreviewModeForFLVFile(){
		info("Declare variables");
		//get a flv file
		fileToUpload = attachFile.getAttachFileByArrayTypeRandom(50);
	...
	@Test
	public void test02_CheckPreviewModeForF4VFile(){
		info("Declare variables");
		//get a flv file
		fileToUpload = attachFile.getAttachFileByArrayTypeRandom(51);
		path=siteExPath.getSiteExpPathByIndex(1);
		nameDrive=siteExDrive.getSiteExpDriveByIndex(0);
	...
	*//**
	...
	private void shareFileAndOpenPreviewMode(String nameDrive,String path,String file){
		...
		acStream.checkSizeActivityPlayer(acStream.ELEMENT_MEDIA_ACTIVITY_PLAYER_FRAME_FLOWPLAYER.replace("${fileName}", file));
