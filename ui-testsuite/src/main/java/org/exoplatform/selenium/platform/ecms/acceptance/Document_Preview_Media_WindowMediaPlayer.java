...
public class Document_Preview_Media_WindowMediaPlayer extends Document_Preview_TestConfig {
	
	
	/**
	 * MEDIA_04:
	 * The Windows Media Player is used to view the file suffixes: 
	 * - wma
	 * - wmv
	 * - mpg
	 * - mpeg
	 ...
	 */
	@Test
	public void test01_CheckPreviewModeForWMAFile(){
		info("Declare variables");
		//get a wma file
		fileToUpload = attachFile.getAttachFileByArrayTypeRandom(58);
	...
	@Test
	public void test02_CheckPreviewModeForWMVFile(){
		info("Declare variables");
		//get a wmv file
		fileToUpload = attachFile.getAttachFileByArrayTypeRandom(59);
		path=siteExPath.getSiteExpPathByIndex(1);
		nameDrive=siteExDrive.getSiteExpDriveByIndex(0);
	...
	@Test
	public void test03_CheckPreviewModeForMPGFile(){
		info("Declare variables");
		//get a mpg file
		fileToUpload = attachFile.getAttachFileByArrayTypeRandom(60);
		path=siteExPath.getSiteExpPathByIndex(1);
		nameDrive=siteExDrive.getSiteExpDriveByIndex(0);
	...
	@Test
	public void test04_CheckPreviewModeForMPEGFile(){
		info("Declare variables");
		//get a mpeg file
		fileToUpload = attachFile.getAttachFileByArrayTypeRandom(61);
		path=siteExPath.getSiteExpPathByIndex(1);
		nameDrive=siteExDrive.getSiteExpDriveByIndex(0);
	...
	@Test
	public void test05_CheckPreviewModeForWKVFile(){
		info("Declare variables");
		//get a wkv file
		fileToUpload = attachFile.getAttachFileByArrayTypeRandom(63);
		path=siteExPath.getSiteExpPathByIndex(1);
		nameDrive=siteExDrive.getSiteExpDriveByIndex(0);
	...
	private void shareFileAndOpenPreviewMode(String nameDrive,String path,String file){
		...
		acStream.checkSizeActivityPlayer(acStream.ELEMENT_MEDIA_ACTIVITY_PLAYER_FRAME_WINDOWPLAYER.replace("${fileName}", file));
